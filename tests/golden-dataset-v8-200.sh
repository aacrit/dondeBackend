...
def detect_cuisines(query, description):
    ...
    mapping = [
        ...
        (["japanese", "sushi", "ramen", "udon", "tempura", "yakitori", "omakase", "sashimi"], "Japanese"),
        (["chinese", "dim sum", "dumpling", "peking", "szechuan", "wonton"], "Chinese"),
        (["thai", "pad thai", "tom yum", "green curry", "thai curry"], "Thai"),
        (["indian", "curry", "biryani", "tikka", "naan", "tandoori"], "Indian"),
        (["korean", "bbq", "bulgogi", "bibimbap", "kimchi", "korean fried"], "Korean"),
        (["french", "bistro", "brasserie", "croissant", "bouillabaisse", "coq au vin"], "French"),
        (["seafood", "lobster", "crab", "oyster", "shrimp", "fish"], "Seafood"),
        (["greek", "gyro", "souvlaki", "spanakopita"], "Greek"),
        (["vietnamese", "pho", "banh mi", "spring roll", "vermicelli"], "Vietnamese"),
        (["mediterranean", "hummus", "falafel", "shawarma", "kebab"], "Mediterranean"),
        (["ethiopian", "injera"], "Ethiopian"),
        (["peruvian", "ceviche", "lomo saltado"], "Peruvian"),
        (["cuban", "cubano", "ropa vieja"], "Cuban"),
        (["polish", "pierogi", "kielbasa"], "Polish"),
        (["filipino", "adobo", "lechon", "sinigang"], "Filipino"),
        (["brazilian", "churrascaria", "churrasco"], "Brazilian"),
        (["turkish", "kebab", "pide"], "Turkish"),
        (["lebanese", "mezze", "kibbeh", "tabbouleh"], "Lebanese"),
        (["spanish", "tapas", "paella", "croqueta"], "Spanish"),
        (["jamaican", "jerk", "plantain"], "Jamaican"),
        (["taiwanese", "beef noodle", "scallion pancake"], "Taiwanese"),
    ]
    matches = []
