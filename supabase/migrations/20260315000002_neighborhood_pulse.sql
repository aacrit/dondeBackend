-- ============================================================================
-- Neighborhood Pulse: Ambient city intelligence RPC
-- Returns contextual restaurant suggestion based on time/day/season
-- for the "Right now in [neighborhood]..." card on the Canvas empty state.
-- ============================================================================
...
BEGIN
  ...
  -- Priority: seasonal relevance + energy match + google rating
  ...
  ORDER BY
    ...
    END) ASC,
    -- Quality tiebreaker
    COALESCE(r.google_rating, 0) DESC
  LIMIT 1
...
-- Grant execute to anon role so frontend can call it without auth
