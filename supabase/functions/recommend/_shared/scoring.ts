...
export const TAG_KEYWORDS: Record<string, string[]> = {
  ...
  "craft cocktails": ["cocktail", "mixology", "craft drinks", "martini", "whiskey", "bourbon", "mezcal", "old fashioned", "aperol", "absinthe", "espresso martini", "tequila", "mojito", "drinks", "bar"],
  ...
  "lively atmosphere": ["bustling", "vibrant", "energetic", "buzzing", "lively", "happening", "high energy", "animated", "festive", "sports bar", "karaoke", "nightlife", "pool hall", "fun", "party"],
